...
static constexpr uint32_t N_ADDR_PINS = 9;
...
static constexpr uint32_t BASE_IO_WR_PIN = 9;

static constexpr uint32_t N_CLK_PINS = 1;
static constexpr uint32_t CLK_OUT_PIN = 22;
...
static constexpr uint32_t ROM_SIZE = 0x200;
